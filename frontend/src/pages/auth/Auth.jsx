...
const Auth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>ChatRift | Login or Signup</title>
        <meta
          name="description"
          content="Login or create an account on ChatRift to start real time messaging with friends."
        />
      </Helmet>
      {/* <div className="h-[calc(var(--vh)_*_100)] w-[100vw] bg-[#1b1c24] text-white flex items-center justify-center"> */}
      <div className="min-h-[calc(var(--vh)_*100)] w-full bg-[#1b1c24] text-white flex items-center justify-center px-4 py-6">
        <h1 className="sr-only">ChatRift Real Time Chat Application</h1>

        <p className="sr-only">
          ChatRift is a real time messaging platform that allows users to send
          instant messages, communicate with friends, and enjoy fast WebSocket
          powered chat.
        </p>
        {/* <div className="max-w-[1200px] border border-[#2f303b] shadow-2xl w-[90vw] md:w-[60vw] lg:w-[50vw] xl:w-[80vw] rounded-3xl bg-[#2c2e3b]"> */}
        <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-xl border border-[#2f303b] shadow-2xl rounded-3xl bg-[#2c2e3b] backdrop-blur-md">
          <div className="flex flex-col gap-4 items-center justify-center px-6 pb-6">
            <div className="flex justify-center items-center flex-col">
              <div className="flex justify-center items-center gap-3 pt-8 pb-4">
                <span className="text-2xl sm:text-3xl font-bold text-white/90 text-center">
                  Welcome to ChatRift
                </span>
              </div>
              <p className="text-sm font-medium text-center text-white/70 md:text-base">
              ...
              >
                ...
                <TabsContent className="flex flex-col gap-4 mt-6" value="login">
                  <Input
                    placeholder="Email"
                    type="email"
                    className="rounded-full px-6 py-5 bg-[#1b1c24] border border-[#2f303b] text-white placeholder-white/40 focus-visible:ring-purple-500"
                    value={email}
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className="absolute right-5 top-3.5 text-white/60 hover:text-white transition-colors"
                  ...
                  <Button
                    className="rounded-full py-5 bg-purple-700 hover:bg-purple-800 active:scale-[0.98] transition-all font-semibold"
                    onClick={handleLogin}
                  >
                    Login
                  </Button>
                      ...
                      <div className="flex justify-center">
                        ...
                        >
                          <InputOTPGroup className="gap-2">
                            <InputOTPSlot
                              index={0}
                              className="w-9 h-9 bg-[#1b1c24] border-[#2f303b] text-white text-lg font-semibold rounded-lg focus:border-purple-500 focus:ring-purple-500"
                            />
                            <InputOTPSlot
                              index={1}
                              className="w-9 h-9 bg-[#1b1c24] border-[#2f303b] text-white text-lg font-semibold rounded-lg focus:border-purple-500 focus:ring-purple-500"
                ...
                <div className="text-center text-gray-400 text-sm font-semibold my-3">
                  or
                </div>
